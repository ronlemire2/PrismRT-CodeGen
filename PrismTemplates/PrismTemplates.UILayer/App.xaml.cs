...
using PrismTemplates.UILogic.Repositories;
using PrismTemplates.UILogic.Services;
...
namespace PrismTemplates.UILayer
{
    /// <summary>
    ...
    sealed partial class App : MvvmAppBase
    {
        ...
        protected override void OnLaunchApplication(LaunchActivatedEventArgs args) {
            NavigationService.Navigate("EntityList", null);
        }
        ...
        protected override void OnInitialize(IActivatedEventArgs args) {
            ...
            _container.RegisterType<IEntityRepository, EntityRepository>(new ContainerControlledLifetimeManager());

            // Register web service proxies
            _container.RegisterType<IEntityServiceProxy, EntityServiceProxy>(new ContainerControlledLifetimeManager());
            ...
            {
                var viewModelTypeName = string.Format(CultureInfo.InvariantCulture, "PrismTemplates.UILogic.ViewModels.{0}ViewModel, PrismTemplates.UILogic, Version=1.0.0.0, Culture=neutral", viewType.Name);
        ...
        protected override void OnRegisterKnownTypesForSerialization() {
            ...
            SessionStateService.RegisterKnownType(typeof(Entity));
        }
    }
}
