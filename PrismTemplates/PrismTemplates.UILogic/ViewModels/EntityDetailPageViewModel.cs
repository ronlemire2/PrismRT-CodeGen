using PrismTemplates.UILogic.Events;
        ...
        private async void OnUpdateEntity() {
            ...
            if (updateErrors.Count == 0) {
                try {
                    ...
                    ErrorMessageTitle = isCreating ? ErrorMessagesHelper.CreateEntityFailedError : ErrorMessagesHelper.UpdateEntityFailedError;
        ...
        private async void OnDeleteEntity() {
            ...
            messageDialog.Commands.Add(new UICommand("Delete", async (command) =>
            {
                try {
                    ...
                    ErrorMessageTitle = ErrorMessagesHelper.DeleteEntityFailedError;
                    ErrorMessage = ex.Message;
                }
                finally {
                    LoadingData = false;
